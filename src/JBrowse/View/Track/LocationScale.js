define([
        ...
        'src/Projection/ProjectionInterface',
        'src/Projection/AbstractProjection',
        'src/Projection/MultisequenceProjection',
        'src/Projection/MultisequenceProjectionFactory'
    ],
    function (declare,
              dom,
              BlockBased,
              ...
              ProjectionInterface,
              AbstractProjection,
              MultisequenceProjection,
              MultisequenceProjectionFactory) {
        return declare(BlockBased,
             ...
             */
            {
                ...
                constructor: function (args) {//name, labelClass, posHeight) {
                    ...
                    this.multisequenceProjection = Projection.MultisequenceProjectionFactory.getProjection(this.refSeq)
                },
